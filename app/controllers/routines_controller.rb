class RoutinesController < ApplicationController
  before_action :set_routine, only: [:show, :edit, :update, :destroy],except:[:dailyrenew]
  ...
  private
    ...
    def routine_params
      params.require(:routine).permit(:driver_id, :shop_id, :day_num, :do_time, :nsacs, :activated, :notif)
    end
end
